...
class A3CAgent():
    def __init__(self, action_size, env_name):
        ...
        self.model_path = os.path.join(os.getcwd(), 'save_model2', 'model')
...
class Runner(threading.Thread):
    ...
    def __init__(self, action_size, state_size, global_model, optimizer, discount_factor, env_name):
...
if __name__ == "__main__":
    global_agent = A3CAgent(action_size=3, env_name="Breakout-v4")
    global_agent.train()
